 ...
 */
enum {   
        MODE_COMBO   = 0, // read int8_t, int8_t, int16_t
        MODE_FORCE   = 0, // read 1x int8_t
        MODE_TOUCHED = 1, // read 1x int8_t
        MODE_TAPPED  = 2, // read 1x int8_t
        MODE_FRAW    = 4, // read 1x int16_t
        MODE_CALIB   = 6, // ??   8x int16_t
};
#endif
